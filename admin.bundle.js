                    ...
                    for (let i = 0; i < 20; i++) {
                        ...
                        f.length > i) {
                            ...
                            h.addEventListener("click", ( () => {
                                t.playUIClick(),
                                e.showConfirm('Are you sure you want to invalidate "' + c.nickname + "\"'s leaderboard entry?", "Cancel", "Invalidate", null, ( () => {
